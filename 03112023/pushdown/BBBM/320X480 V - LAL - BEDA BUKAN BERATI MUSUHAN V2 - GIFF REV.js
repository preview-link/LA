...
// stage content:
(lib._320X480VLALBEDABUKANBERATIMUSUHANV2GIFFREV = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(158.6,240,1,1,0,0,0,162,240.5);
	...
	// BEDA
	this.instance_6 = new lib.BEDA_1();
	...
	// BUKAN
	this.instance_7 = new lib.BUKAN_1();
	...
	// BERARTI
	this.instance_8 = new lib.BERARTI_1();
	...
	// MUSUHAN
	this.instance_9 = new lib.MUSUHAN_1();
	this.instance_9.setTransform(-3,240,1,1,0,0,0,160,240);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(22).to({_off:false},0).to({x:160},14,cjs.Ease.quintOut).wait(129));

	// MIKIR
	this.instance_10 = new lib.MIKIR();
	this.instance_10.setTransform(76,176.05,0.0246,0.0246,0,0,0,75.2,176.8);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(29).to({_off:false},0).to({regY:176.9,scaleX:0.9897,scaleY:0.9897,y:176},14,cjs.Ease.bounceOut).wait(122));

	// BINATANGC
	this.instance_11 = new lib.BINATANGC();
	this.instance_11.setTransform(432.1,360,1.1416,1.1416,0,0,0,160.1,240);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({_off:true},34).wait(13).to({_off:false,x:230.1},0).to({_off:true},2).wait(35).to({_off:false,regX:160,scaleX:1,scaleY:1,x:230,y:240},0).to({_off:true},2).wait(44).to({_off:false},0).to({_off:true},2).wait(33));

	// BINATANG
	this.instance_12 = new lib.BINATANG_1();
	this.instance_12.setTransform(432.1,360,1.1416,1.1416,0,0,0,160.1,240);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({x:230.1},49,cjs.Ease.quintOut).to({regX:160,scaleX:1,scaleY:1,x:230,y:240},20,cjs.Ease.quintOut).wait(96));
